...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { address: @parking.address, email: @parking.email, name: @parking.name, phone: @parking.phone } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { address: @parking.address, email: @parking.email, name: @parking.name, phone: @parking.phone } }
